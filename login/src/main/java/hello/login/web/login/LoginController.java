...
public class LoginController {
    ...
    public String loginV1(@Valid @ModelAttribute LoginForm form, BindingResult bindingResult, HttpServletResponse response) {
        ...
        //세션 쿠키(쿠키에 시간 정보 X)-> 브라우저 종료 시 소멸
    ...
    public String loginV2(@Valid @ModelAttribute LoginForm form, BindingResult bindingResult, HttpServletResponse response) {
        ...
        //세션 관리자를 통해 세션 생성, 회원 데이터 보관하기
        sessionManager.createSession(loginMember, response); //쿠키 생성되고 response에 저장됨
